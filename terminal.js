...
function doCommand() {
  ...
  switch ((cmdSplit[0])) {
    ...
    case "welcome": {
      output.innerHTML = "<ul>Welcome to the CST Command Line<li>CST stands for (@d3n, (#@r2|3, $|m0n, and 70DD<ul>";
      output.className = "output";
      break;
    }
    case "html": {
